...
kodu zaczynająca się od \texttt{cout} (linia~\ref{lst:hello_cout}). Możemy 
zmienić zawartość cudzysłowów na inny tekst, który zostanie wyświetlony 
w zamian.
...
\begin{try}
Napisz program, który wyświetli na ekranie kilka pierwszych wersów
inwokacji z ,,Pana Tadeusza''. Umieść łamania linii w odpowiednich miejscach.
Pamiętaj o unikaniu polskich znaków!
\end{try}
